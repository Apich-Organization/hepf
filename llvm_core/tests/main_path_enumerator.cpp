...
TEST(PathEnumeratorTest, CorrectlyEnumeratesPaths) {
  CommandExecutor executor(PROJECT_ROOT_PATH);

  std::string test_file = "test_path_enumerator.cpp";
  std::string pass_name = "path-enumerator";
  ...
  std::ifstream ir_file("/tmp/test_path_enumerator.ll");
  std::string ir_line;
